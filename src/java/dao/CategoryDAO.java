...
// hiển thị chi tiết sản phẩm
    ...
    // get danh sách thể loại cho nón bảo hiểm
    public ArrayList<Category> getListCategoryNonbaohiem() throws SQLException {
        Connection connection = DBConnect.getConnection();
        String sql = "SELECT * FROM category where category_group='Nón bảo hiểm'";
        PreparedStatement ps = connection.prepareCall(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Category> list = new ArrayList<>();
        while (rs.next()) {
    ...
    // get danh sách thể loại cho phụ kiện
    public ArrayList<Category> getListCategoryPhukien() throws SQLException {
        Connection connection = DBConnect.getConnection();
        String sql = "SELECT * FROM category where category_group='Phụ kiện'";
        PreparedStatement ps = connection.prepareCall(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Category> list = new ArrayList<>();
        while (rs.next()) {
