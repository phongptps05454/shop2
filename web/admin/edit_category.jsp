                        ...
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" action="/shop/ManagerCategoryServlet" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <%
                                            if (category.getCategoryGroup().equals("Nón bảo hiểm")) {
                                        %>
                                        <input type="radio" name="groupDanhMuc" value='Nón bảo hiểm' checked> Nón bảo hiểm
                                        <input type="radio" name="groupDanhMuc" value='Phụ kiện'> Phụ kiện        
                                        <%} else { %>
                                        <input type="radio" name="groupDanhMuc" value='Nón bảo hiểm'> Nón bảo hiểm           
                                        <input type="radio" name="groupDanhMuc" value='Phụ kiện' checked> Phụ kiện
                                        <%}%>
