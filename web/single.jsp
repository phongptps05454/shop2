<%-- 
    Document   : single
    Created on : Oct 15, 2017, 2:16:09 PM
    Author     : phong
--%>
                        ...
                        <div class="col-md-9 single-grid">
                            <div clas="single-top">
                                ...
                                <div class="single-right simpleCart_shelfItem">
                                    ...
                                    <p class="price item_price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "<%=product.getProductPrice() %>" /> Đồng</p>
                                    <div class="description">
                                        <p><span>Mô tả ngắn : </span> <%=product.getProductDescription()%> </p>
                                    </div>
                                    <div class="women">
                                        <span class="size">XL / XXL / S </span>
                                        <a href="CartServlet?command=single&productID=<%=product.getProductID()%>" data-text="Add To Cart" class="my-cart-b item_add">Mua</a>
                                    </div>
