<%-- 
    Document   : product
    Created on : Oct 5, 2017, 8:15:48 AM
    Author     : phong
--%>
                            ...
                            <div class="col-md-3 product-agileinfo-grid">
                                <div class="categories">
                                    ...
                                    <ul class="tree-list-pad">
                                        <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Phụ kiện</label>
                                            <ul>
                                            <%
                                        ...
                                        <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Nón bảo hiểm</label>
                                            <ul>
                                            <%
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem" style="margin-bottom: 50px;">
                                                    <div class="grid-arr">
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            <p><em><%=format.formatNumber(p.getProductPrice())%></em> VNĐ</p>
                                            ...
                                            <div class="product-tab1">
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        ...
                                                        <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Mua</a>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
